...
import 'package:flutter_quill_extensions/embeds/others/image_video_utils.dart';
...
import 'custom_video_play.dart';



class CustomQuillToolbarVideoButton extends StatelessWidget {
  const CustomQuillToolbarVideoButton({
  ...
  Future<void> _onPressedHandler(BuildContext context) async {
    ...
    final imageSource = await customShowSelectVideoSourceDialog(context: context);
